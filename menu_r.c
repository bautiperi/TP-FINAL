...
void menu_vis(int mapa[][COL])
{
    ...
    dcoord_t linea_opt0[5] = {{13, 1}, {13, 2}, {13, 3}, {13, 4}, {13, 5}};
    dcoord_t linea_opt1[6] = {{13, 9}, {13, 10}, {13, 11}, {13, 12}, {13, 13}, {13, 14}};
    for (i = 0; i < 42; i++)
    {
...
void menu_principal_vis(int mapa[][COL])
{
    ...
    dcoord_t linea_opt0[6] = {{15, 1}, {15, 2}, {15, 3}, {15, 4}, {15, 5}, {15, 6}};

    dcoord_t linea_opt1[5] = {{15, 9}, {15, 10}, {15, 11}, {15, 12}, {15, 13}};
    int i;
    shutdown_disp();
